...
.app-container { background-image: url("@/assets/pokemon-bg.jpg") !important; background-size: cover; background-position: center; }
...
.pikachu { position: fixed; bottom: 0; left: 0; height: 80px; animation: move-pikachu 10s linear infinite; pointer-events: none; z-index: 9999; }
@keyframes move-pikachu {
  ...
  150% { transform: translateX(0) scaleX(1); }
}
